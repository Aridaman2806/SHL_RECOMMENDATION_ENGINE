...
class RecommendationEngine:
    def __init__(self, csv_path, index_dir):
      ...
      Given the following query: "{query}"
        ...
        - URL (use actual URLs from the metadata and prepend https://www.shl.com/)
    ...
    def get_recommendations(self, query):
        ...
        retrieved_docs = "\n".join([
            ...
            f"Type: {doc.metadata['test_type']}, Duration: {doc.metadata['duration']}, URL: www.shl.com{doc.metadata['url']}"
            for doc in docs
        ])
